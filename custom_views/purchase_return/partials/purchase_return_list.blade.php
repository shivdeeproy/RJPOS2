    ...
    <table class="table table-bordered table-striped ajax_view" id="purchase_return_datatable">
        <thead>
            <tr>
                ...
                <th>@lang('purchase.total_without_tax')</th>
        ...
        <tfoot>
            <tr class="bg-gray font-17 text-center footer-total">
                ...
                <td id=""><span class="display_currency" id="footer_total_without_tax" data-currency_symbol ="true"></span></td>
                <td id=""><span class="display_currency" id="footer_total_tax" data-currency_symbol ="true"></span></td></td>
